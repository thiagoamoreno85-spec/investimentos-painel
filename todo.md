...
## Botão Ocultar/Mostrar Saldos Financeiros - CONCLUÍDO (Fase 1 + Fase 2 Parcial)
...
- [ ] Aplicar blur nos valores de: Rent. Mês (Fase 2)
...
- [x] pnpm build sem erros (built in 22.28s ✅)
- [x] pnpm test todos passando (96 testes ✅)
